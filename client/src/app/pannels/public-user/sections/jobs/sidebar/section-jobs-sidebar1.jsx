...
function SectionJobsSidebar1() {
    ...
    const filterJobsHandler = (e) => {
        ...
        const filtered = jobs.filter(job => job.title === value);
                ...
                <div className="sidebar-elements search-bx">
                    <form>
                        <div className="form-group mb-4">
                            ...
                            <select onChange={filterJobsHandler} className="wt-select-bar-large selectpicker" data-live-search="true" data-bv-field="size">
